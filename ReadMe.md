...
Resolução dos exercícios de fixação sobre as Collections em Java, que foram disponibilizados no curso <b>"Santader - Java Back-End"</b> da [<b>DIO</b>](https://web.dio.me/). As propostas estão abaixo nesse documento e as resoluções podem ser encontradas na pasta src deste repositório.
...
## Fixando os Conhecimentos sobre o Map
...
## Fixando os Conhecimentos sobre o Set
